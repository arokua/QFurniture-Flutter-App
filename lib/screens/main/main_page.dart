...
// Removed timeline headers - not needed for furniture shop
...
class _MainPageState extends State<MainPage>
  ...
  Widget build(BuildContext context) {
    ...
    // Removed timeline header - not needed for furniture shop

    // Removed generic tab bar - will be replaced with furniture categories later
                    ...
                    FutureBuilder<List<Product>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final displayProducts =
                            apiProducts != null && apiProducts.isNotEmpty
                                ? apiProducts
                                : products;
